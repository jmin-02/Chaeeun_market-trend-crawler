"""Brunch Tech (브런치) crawler.

Brunch Tech is a tech-focused section on Brunch, a Korean blogging platform.
"""
...
class BrunchTechCrawler(BaseCrawler):
    """Crawler for Brunch Tech (브런치) - https://brunch.co.kr"""

    def extract_articles(self, html: str, source: str, language: str = "ko") -> list[Article]:
        """Extract articles from Brunch Tech.
