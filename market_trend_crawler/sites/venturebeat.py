...
VentureBeat transforms enterprise technology coverage.
"""
...
class VentureBeatCrawler(BaseCrawler):
    """Crawler for VentureBeat - https://venturebeat.com"""
    ...
    def extract_articles(self, html: str, source: str, language: str = "en") -> list[Article]:
        ...
        for item in soup.select("article") or soup.select(".ArticleListing"):
            try:
                # Extract title
