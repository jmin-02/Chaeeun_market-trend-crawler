...
KOREAN_SITES_CONFIG = [
    ...
    KoreanSiteConfig(
        ...
        language=SourceLanguage.KOREAN,
        enabled=True,
        notes="Naver's developer and tech blog (Atom feed)",
    ),
    KoreanSiteConfig(
        name="Danawa Tech",
    ...
    KoreanSiteConfig(
        ...
        crawler_class="TossTechCrawler",
        language=SourceLanguage.KOREAN,
        enabled=True,
        notes="Toss fintech engineering blog (RSS feed)",
    ),
    KoreanSiteConfig(
        name="Woowahan",
        url="https://techblog.woowahan.com",
        crawler_class="WoowahanCrawler",
        language=SourceLanguage.KOREAN,
        enabled=True,
        notes="Woowahan Bros (Baemin) engineering blog",
    ),
    KoreanSiteConfig(
        name="Daangn",
        url="https://medium.com/feed/daangn",
        crawler_class="DaangnCrawler",
        language=SourceLanguage.KOREAN,
        enabled=True,
        notes="Daangn (Karrot) tech blog on Medium (RSS feed)",
    ),
    KoreanSiteConfig(
        name="Hwahae",
        url="https://blog.hwahae.co.kr",
        crawler_class="HwahaeCrawler",
        language=SourceLanguage.KOREAN,
        enabled=True,
        notes="Hwahae beauty tech engineering blog",
    ),
    KoreanSiteConfig(
        name="Gangnam Unni",
        url="https://blog.gangnamunni.com",
        crawler_class="GangnamUnniCrawler",
        language=SourceLanguage.KOREAN,
        enabled=True,
        notes="Gangnam Unni beauty/health tech engineering blog",
    ),
    KoreanSiteConfig(
        name="Kakao Tech",
        url="https://tech.kakao.com/feed",
        crawler_class="KakaoTechCrawler",
        language=SourceLanguage.KOREAN,
        enabled=True,
        notes="Kakao engineering blog (RSS feed)",
    ),
    KoreanSiteConfig(
        name="Ridi",
        url="https://ridicorp.com/feed/",
        crawler_class="RidiCrawler",
        language=SourceLanguage.KOREAN,
        enabled=True,
        notes="Ridi digital content company engineering blog",
    ),
    KoreanSiteConfig(
        name="Kurly",
        url="https://helloworld.kurly.com",
        crawler_class="KurlyCrawler",
        language=SourceLanguage.KOREAN,
        enabled=True,
        notes="Kurly e-commerce HelloWorld engineering blog",
    ),
]
