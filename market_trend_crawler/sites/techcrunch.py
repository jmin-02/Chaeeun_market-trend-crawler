...
reviewing new Internet products, and breaking tech news.
"""
...
class TechCrunchCrawler(BaseCrawler):
    """Crawler for TechCrunch - https://techcrunch.com"""

    BASE_URL = "https://techcrunch.com"

    def extract_articles(self, html: str, source: str, language: str = "en") -> list[Article]:
        """Extract articles from TechCrunch with enhanced error handling.
