...
Gigaom provides research and emerging technology news for business and IT leaders.
"""
...
class GigaomCrawler(BaseCrawler):
    """Crawler for Gigaom - https://gigaom.com"""

    def extract_articles(self, html: str, source: str, language: str = "en") -> list[Article]:
        """Extract articles from Gigaom.
        ...
        # Gigaom article structure
        for item in soup.select("article") or soup.select(".post-item"):
            try:
                # Extract title
