...
class GizmodoCrawler(BaseCrawler):
    """Crawler for Gizmodo - https://gizmodo.com"""

    def extract_articles(self, html: str, source: str, language: str = "en") -> list[Article]:
        """Extract articles from Gizmodo.
